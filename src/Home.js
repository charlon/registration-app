      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4">
            ...
            <p><a class="btn btn-secondary" href="#" role="button">Manage Plan &raquo;</a></p>
          </div>
          <div class="col-md-4">
            <h2>Register</h2>
            ...
            <p><a class="btn btn-secondary" href="/register" role="button">Winter Quarter 2018 &raquo;</a></p>
          </div>
          <div class="col-md-4">
            <h2>Track</h2>
            <p>Donec sed odio dui. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Vestibulum id ligula porta felis euismod semper. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus.</p>
            <p><a class="btn btn-secondary" href="#" role="button">Audit Degree (DARS) &raquo;</a></p>
          </div>
        </div>
