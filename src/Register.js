    ...
    <div role="main">
      ...
      <div className="jumbotron">
        ...
        <h1 className="display-3">Register</h1>
            ...
            <p className="lead">
              <a className="btn btn-primary btn-lg" href="#" role="button">Winter Quarter 2018</a>
            </p>
        </div>
      </div>
      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-md-4">
            ...
            <p><a className="btn btn-secondary" href="/courses" role="button">Winter Quarter 2018 &raquo;</a></p>
          </div>
          <div className="col-md-4">
            <h2>asdfasdf</h2>
